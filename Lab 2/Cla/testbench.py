...
random.seed(12345)
def test_runCocotbTestsGp4(pytestconfig):
    runCocotbTestsGp4(pytestconfig)
def runCocotbTestsGp4(pytestconfig):
    ...
    runr.test(
        ...
        # no testcase arg -> run all tests
    )

    pass
def test_runCocotbTestsCla(pytestconfig):
    runCocotbTestsCla(pytestconfig)
